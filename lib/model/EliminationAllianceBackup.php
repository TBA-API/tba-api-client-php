...
/**
 * EliminationAllianceBackup Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class EliminationAllianceBackup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Elimination_Alliance_backup';
     ...
     * Sets in
     *
     * @param string|null $in Team key that was called in as the backup.
     *
     * @return $this
     */
     ...
     * Sets out
     *
     * @param string|null $out Team key that was replaced by the backup team.
     *
     * @return $this
     */
